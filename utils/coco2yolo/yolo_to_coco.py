...
parser.add_argument('--root_dir', default='C:/YOLOv5/yolov5-5.0/runs/detect/exp17', type=str, help="root path of images and labels, include ./images and ./labels and classes.txt")
parser.add_argument('--save_path', type=str, default='C:/YOLOv5/yolov5-5.0/runs/detect/train.json', help="if not split the dataset, give a path to a json file")
...
def train_test_val_split_random(img_paths, ratio_train=1, ratio_test=0, ratio_val=0):
    # 这里可以修改数据集划分的比例。
...
def yolo2coco(arg):
    ...
    if arg.random_split:
        ...
        train_img, val_img, test_img = train_test_val_split_random(indexes, 1, 0, 0)
